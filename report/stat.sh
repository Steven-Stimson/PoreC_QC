...
cat $1.map.stat.tsv |awk -v OFS="\t" 'BEGIN{print "type\tread_count\tread_ratio(%)\tbase_count\tbase_ratio(%)"}{if(NR==2){r=$2;b=$3}else if(NR>2){rr=$2/r*100;br=$3/b*100;print $1,$3,br,$2,rr}}' | digit_formatter.pl -k -f 2 > $1.align.stat.tsv
